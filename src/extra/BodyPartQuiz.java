...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if(guess == "arnold" || guess == "arnold schwarzenegger")
		{
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "You are incorrect. This is Arnold Schwarzenegger" );
		...
		if(guess1 == "Leonardo" || guess1 == "Leonardo Decaprio")
		{
			...
			JOptionPane.showMessageDialog(null, "You are incorrect. This is Leonardo Decaprio." );
	...
	String guess2= JOptionPane.showInputDialog("Who is this?");
		...
		if(guess2 == "Morgan" || guess2 == "Morgan Freeman")
		{
			JOptionPane.showMessageDialog(null, "Correct!");
			score++;
		}
			...
			JOptionPane.showMessageDialog(null, "You are incorrect. This is Morgan Freeman." );
	...
	String guess3= JOptionPane.showInputDialog("Who is this?");
		...
		if(guess3 == "Jack")// || guess3 == "Jack Black")
		{
			JOptionPane.showMessageDialog(null, "Correct!");
			score++;
		}
